      ...
      describe 'POST #create' do
        context 'log in' do
          ...
          context 'can not create product' do
            let(:invalid_product){{user_id: user, product: attributes_for(:product, name: nil, content: nil, status_id: nil, burden_id: nil, day_id: nil, price: nil, derivery_id: nil, image: nil, category_id: nil, seller_id: nil)}}
